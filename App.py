...
import requests
API_KEY = "33dde683fb84130857b1fdeebe678401"

# Getting user city as a input
user_input = input("Enter a city : ")

#Request weather data
weather_data = requests.get(f"https://api.openweathermap.org/data/2.5/weather?q={user_input}&appid=33dde683fb84130857b1fdeebe678401&units=metric")
